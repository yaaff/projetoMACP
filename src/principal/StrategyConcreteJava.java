...
public class StrategyConcreteJava implements StrategyHighlight {
	/** Concrete Strategy de Fazer Highlight em Java */
	public StrategyConcreteJava(){
	...
	public void fazerHighlight(JTextPane aux){		
		...
		while(inPos < areaDeTexto.getText().length()){	
			...
			if(palavra.equals("public") || palavra.equals("static") || palavra.equals("private") || palavra.equals("protected")){
				areaDeTexto.select(inicio, fim);
				append(inicio, fim, areaDeTexto.getSelectedText(),0);
			}
                        //AZUL CLARO normal
			if(palavra.equals("if") || palavra.equals("void") || palavra.equals("float") || palavra.equals("String") || palavra.equals("double") || palavra.equals("function") || palavra.equals("for") || palavra.equals("while") || palavra.equals("repeat") || palavra.equals("do")|| palavra.equals("return") || palavra.equals("Scanner")){
				areaDeTexto.select(inicio, fim);
				append(inicio, fim, areaDeTexto.getSelectedText(),1);
			}
                        //VERDE CLARO bold
			if(palavra.equals("true") || palavra.equals("false")){
				areaDeTexto.select(inicio, fim);
			...
			if(palavra.equals("break") || palavra.equals("continue")){
				...
				append(inicio, fim, areaDeTexto.getSelectedText(),2);
                        ...
                        //ROXO bold
			if(palavra.equals("import") || palavra.equals("class") || palavra.equals("null") || palavra.equals("new") ){
				areaDeTexto.select(inicio, fim);
