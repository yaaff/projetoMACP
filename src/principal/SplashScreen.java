...
@Deprecated
//Não utilizado mais. Novo metodo do NetBeans utilizado em 2012
...
/** Splashscreen do programa */
  public void showSplash() {
    ...
    JLabel label = new JLabel(new ImageIcon(getClass().getResource("img/splash.png")));
    JLabel copyrt = new JLabel("Copyright 2007-2012, MACP",
        JLabel.CENTER);
