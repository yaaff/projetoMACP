...
public class StrategyConcreteCpp implements StrategyHighlight {
	/** Concrete Strategy de Fazer Highlight em C++ */
	public StrategyConcreteCpp(){
	...
	public void fazerHighlight(JTextPane aux){		
		...
		while(inPos < areaDeTexto.getText().length()){	
			...
			if(palavra.equals("include") || palavra.equals("define")){
				areaDeTexto.select(inicio, fim);
			...
			if(palavra.equals("using") || palavra.equals("namespace")){
				areaDeTexto.select(inicio, fim);
