...
public class SemanticaPascal {
	...
	public SemanticaPascal( Token tk ) {
	...
	private String list_decl(){
		...
		if( tk.getClas() == 51 && tk.getNext() != null){// verifica se h� o terminal ";" no fim da declara��o
			if( codigoAux != "" )
				codigoGerado += "\t"+codigoAux + ":" + codigoTipoAux + "\n";
			tk = tk.getNext();			
			codigoAux = "";
                        codigoTipoAux = "";
		}
	...
	private int tipo( ){
		...
		if( tip > 1 && tip < 7 ){
			switch( tip ){
				...
				case 4:{
					codigoTipoAux += "boolean; ";
					break;
				}				
				case 5:{
					codigoTipoAux += "string; ";
					break;
				}				
				case 6:{
					codigoTipoAux += "char; ";
